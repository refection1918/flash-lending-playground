...
contract boba_etherscan_Basic_L1_Test is BobaEtherscanCommon {
    ...
    function skip_test__batchRelayMessages() public {
        ...
        L1MultiMessageRelayer.L2ToL1Message[]
            memory messages = new L1MultiMessageRelayer.L2ToL1Message[](1);
        messages[0].target = address(proxy__L1__StandardBridge);
        messages[0].sender = address(0);
        messages[0]
            .message = hex"";
        ...
        stateRootBatchHeader
            .batchRoot = hex"cf2df7e7df6c683bd523a2a32005a3e499bef8db9b4bc7bbf5d35cc10bc49b92";
        stateRootBatchHeader.batchSize = 40;
        stateRootBatchHeader.prevTotalElements = 993546;
        stateRootBatchHeader
            .extraData = hex"00000000000000000000000000000000000000000000000000000000642575270000000000000000000000005558c63d5bf229450995adc160c023c9f4d4be80";
        ...
        siblings[
            0
        ] = hex"d3bc70b03121cceeb24efec96880d3f1978a2a7e5ffe6845639567da276358ca";
        siblings[
            1
        ] = hex"44065db30a9ffe00462d4e5e7dd55ffdd08ff934f48d38ee88329d4f9da96819";
        siblings[
            2
        ] = hex"b75f1aeae5bffeeda50604573a6dd184ac99fe1a8dbea2b16721a17904405617";
        siblings[
            3
        ] = hex"30db367e518033cc05a74b4afec71f8d9f103bf270c594851b4c7c4683518ee3";
        siblings[
            4
        ] = hex"8b33ef389d0592dc257fc59e53d4d510b98fa7c2be06063578d027657bd2ceb7";
        siblings[
            5
        ] = hex"d78effff421c49b006d4d4f8a5a37f5d25e14cde1cf3d8b33aca29205b3b3294";
        stateRootProof.siblings = siblings;

        IL1CrossDomainMessenger.L2MessageInclusionProof memory proof;
        proof
            .stateRoot = hex"f04585bfdea21b17d823a4095533f9ef89a5d75f33b7414a20edac8d9544384b";
    ...
    function test__finalizeERC20Withdrawal() public {
        ...
        proxy__L1__StandardBridge.finalizeERC20Withdrawal(
            l1Token,
            l2Token,
            from,
            to,
